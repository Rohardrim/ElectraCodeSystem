...
public class Controller{
   ...
   @FXML
   Button availability, takeSupply, sentMessage, sentProducts; // sub menu buttons
   ...
   @FXML
    ...
    @FXML
    TableView usersTableView, ordersTableView; // user table view
    ...
    public void loadUsers(){
        ...
        usersList.add(new User(1,"alicja","jaszczebska@wp.pl"));
        usersList.add(new User(2,"lalek","jaszczebska@wp.pl"));
        usersList.add(new User(3,"heniek","wiesiek@wp.pl"));
        usersList.add(new User(4,"linkin","park@wp.pl"));
        usersList.add(new User(5,"behe","mot@wp.pl"));

        usersTableView.setItems(usersList);
    }

    //check orders button action for tests -- chande to data from database
    //*
    // *
...
//*
    // *
    //ccheck orders button action for tests -- chande to data from database END


    //changed all checkbox to selected
    //*
    // *
    ...
    //*
    // *
    //changed all checkbox to selected END
...
//            System.out.println(v.getKey()+" = "+v.getValue());
    ...
    private void handleAction(MouseEvent event){
        ...
        if (event.getSource() == takeSupply) {
            setOrderHeaderLabel(takeSupply.getText());
            topLabel.textProperty().bind(orderHeaderLabelProperty());
    ...
    public void closeWindow() throws Exception{
        ...
        System.out.println(alert.dialogPaneProperty().get());
